...
nist_test_suite()
{
	   // --- START OF YASH'S CUSTOM BIT-PACKING & STREAMING ROUTINE ---
    ...
    // IMPORTANT: If you UNCOMMENT the line below, the program will exit after
    // saving the first chunk. To stream 1GB over multiple loops, LEAVE IT COMMENTED!
    // exit(0);
    // --- END OF YASH'S CUSTOM ROUTINE ---



    // ... [The rest of the default nist_test_suite() code follows here] ...
